  ...
  <div id="main-container">
    <div class="flex-container">
      ...
      <table align="center"  width="100%">
        <thead>
          <tr align="center">
              <td colspan="" style="font-size: 120%; font-weight: bold;">VOLUNTARIOS</strong></td>
          </tr>
        </thead>
      </table>   
      <br>
      ...
      <table align="center"  border="1" >
        <thead>
          ...
          <tr style="background-color: #CACFD2; color: black;font-weight: bold; font-size: 15px;" class='content' id="cabeza">
            ...
            <th style="font-size: 85%;" align="center">VOLUNTARIO</th>
        ...
        <tbody>
            ...
            @foreach ($voluntarios as  $value)
                <tr class='content'>
                    ...
                    <td style="font-size: 80%;">{{$value->celular}}</td>
                    <td style="font-size: 80%;" align="center">{{$value->refugio}}</td>
                    <td style="font-size: 80%;" align="center">{{$value->estado == true?'ACTIVO':'BLOQUEADO'}}</td>
