...
export default function AdopcionCreate({auth,mascotas}){
    const { data, setData, post, processing, errors } = useForm({
        ...
        descripcion: '',
        fecha: '',
        mascotaId:mascotas.length != 0 ?mascotas[0].id:'',
    });
  ...
  return (
    ...
    <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Nueva Adopcion</h2>}
        >
