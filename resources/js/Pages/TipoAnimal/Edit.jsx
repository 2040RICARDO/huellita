...
export default function EditRefugio({auth,animal}){
    ...
    const submit = (e) => {
        ...
        post(route('tipoAnimal_a.actualizar', { id: animal.id }));
    };
  ...
  return (
    ...
    <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Editar Tipo de Animal</h2>}
        >
