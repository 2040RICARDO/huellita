...
export default function EditVoluntario({auth,refugios,voluntario}){
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('voluntario.update', { voluntario: voluntario.id }));
        //post(route('voluntario.store'));
    };
  return (
    
    <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Editar Voluntario</h2>}
        >
                        ...
                        <div className="md:w-1/2 px-3">
                            ...
                            <div className="flex items-center space-x-4">
                                <label className="inline-flex items-center rounded-lg border border-gray-300 p-2 hover:border-blue-500 transition-all duration-300 mr-16" >
                                    ...
                                    />
                                    <span className="ml-2 text-sm font-semibold">ACTIVO</span>
                                </label>
                                <label className="inline-flex items-center rounded-lg border border-gray-300 p-2 hover:border-blue-500 transition-all duration-300">
                                    ...
                                    />
                                    <span className="ml-2 text-sm font-semibold">SUSPENDIDO</span>
                                </label>
                            </div>
